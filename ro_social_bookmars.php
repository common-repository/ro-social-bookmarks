<?php
/*
Plugin Name: RO Social Bookmarks
Version: 1.7.1
Plugin URI: http://www.dream-webdesign.ro
Author: Dream Webdesign
Author URI: http://www.dream-webdesign.ro
Description: RO Social Bookmarks - Adds the social bookmarks icons to blog articles. This plugin is based on Social Bookmarks and Social Bookmarking Reloaded plugins and contains basic social services plus extra Romanian services. 

    Copyright 2010 - 2011  DREAM WEBDESIGN (Email: office@dream-webdesign.ro)
...
class social_bookmarks
{
	...
	function social_bookmarks()
	{
		...
		$this->plugin_dir = get_option('siteurl').'/wp-content/plugins/ro-social-bookmarks/'; 
	...
	{
		print("<link rel=\"stylesheet\" type=\"text/css\" media=\"screen\" href=\"".$this->plugin_dir."ro_social_bookmarks.css\" />\n");
	}
	...
	function admin_menu()
	{
		...
		add_options_page('RO Social Bookmarks', 'RO Social Bookmarks', 8, __FILE__, array(&$this, 'plugin_options'));
	...
	function plugin_options()
	{
		...
		print('<h2>RO Social Bookmarks</h2>');
...
//  		$this->debug_section();
	...
	function render_plugin()
	{
		...
		$html = "<!-- RO Social Bookmarks BEGIN -->";
		...
		$html .= "</div><div id=\"dwcredit\"><a id=\"dwlogo\" href=\"http://www.dream-webdesign.ro\" title=\"Web design\">web design</a></div>\n";
